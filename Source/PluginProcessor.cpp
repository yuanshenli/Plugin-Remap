...
//==============================================================================
const String NewPlugInAudioProcessor::getName() const
{
...
const String NewPlugInAudioProcessor::getProgramName (int index)
{
    return String();
}

void NewPlugInAudioProcessor::changeProgramName (int index, const String& newName)
{
}
...
void NewPlugInAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
    ...
    audioSource.prepareToPlay(sampleRate, samplesPerBlock);
}
...
bool NewPlugInAudioProcessor::setPreferredBusArrangement (bool isInput, int bus, const AudioChannelSet& preferredSet)
{
...
void NewPlugInAudioProcessor::processBlock (AudioSampleBuffer& buffer, MidiBuffer& midiMessages)
{
...
//    }
    audioSource.getNextAudioBlock(buffer, midiMessages);
}
...
AudioProcessorEditor* NewPlugInAudioProcessor::createEditor()
{
    return new NewPlugInAudioProcessorEditor (*this);
}

//==============================================================================
void NewPlugInAudioProcessor::getStateInformation (MemoryBlock& destData)
{
